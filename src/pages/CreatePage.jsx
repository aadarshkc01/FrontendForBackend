...
const handleChange = (event)=>{
  // let name = event.target.name  kun name ma rakheko
  // let value = event.target.value  name ma value k aairako xa
    ...
    <form onSubmit={submitData}>
      <div className="grid grid-cols-6 gap-6">
        ...
        <div className="col-span-6 sm:col-span-3">
          ...
          <input onChange={handleChange} type="text" name="bookAuthor" id="category" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Robert k jhvdw" required />
        </div>
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="brand" className="text-sm font-medium text-gray-900 block mb-2">Book Genre</label>
          <input onChange={handleChange} type="text" name="bookGenre" id="brand" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Fictional" required />
        </div>
        <div className="col-span-6 sm:col-span-3">
